    ...
    <main className="container mx-auto flex flex-col px-4 sm:px-6 md:px-7 lg:px-8">
      <div className="mt-4 w-full">
        <div className="grid grid-cols-2 gap-2">
          <div className="mx-auto text-xl font-extralight">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <div className="mx-auto text-xl font-extralight">The Cafe Holic</div>
          <div>
            <img
              className="rounded-full p-12"
        ...
        <div>
          <div>The Tech-heavy Investor</div>
          <div>
            <img />
          </div>
        </div>
        <div>
          <div>Vinge F45 Attentee</div>
          <div>
            <img />
          </div>
        </div>
        <div>
          <div>Reader for everything</div>
          <div>
            <img />
          </div>
        </div>
        <div>
          <div>Blogger of life</div>
          <div>
            <img />
          </div>
        </div>
